...
| Пример отправки опроса                               | [sendPoll.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/sendPoll.php)                                 |
| Пример отправки интерактивных кнопок                 | [sendInteractiveButtons.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/sendInteractiveButtons.php)     |
| Пример изменения настроек группы                     | [updateGroupSettings.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/updateGroupSettings.php)           |
| Пример получения списка чатов                        | [getChats.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/getChats.php)                                 |
...
| `account.updateApiToken`               | Метод предназначен для обновления токена инстанса                                                                         | [UpdateApiToken](https://green-api.com/docs/api/account/UpdateApiToken/)                                  |
...
| `groups.updateGroupSettings`           | Метод изменяет настройки группового чата                                                                                  | [UpdateGroupSettings](https://green-api.com/docs/api/groups/UpdateGroupSettings/)                         |
...
| `sending.sendInteractiveButtons`       | Метод предназначен для отправки сообщения с интерактивными кнопками в личный или групповой чат                            | [SendInteractiveButtons](https://green-api.com/docs/api/sending/SendInteractiveButtons/)                  |
| `sending.sendInteractiveButtonsReply`  | Метод предназначен для отправки ответного сообщения с интерактивными кнопками в личный или групповой чат                  | [SendInteractiveButtonsReply](https://green-api.com/docs/api/sending/SendInteractiveButtonsReply/)        |
...
| `serviceMethods.getChats`              | Метод возвращает список чатов текущего аккаунта                                                                           | [GetChats](https://green-api.com/docs/api/service/GetChats/)                                              |
