...
### Sending a message with poll to a WhatsApp number
...
| Example of sending a message with poll                         | [sendPoll.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/sendPoll.php)                                   |
...
| `sending.sendPoll`                     | The method is designed for sending message with poll to a personal or group                                              | [SendPoll](https://green-api.com/en/docs/api/sending/SendPoll/)                                             |
