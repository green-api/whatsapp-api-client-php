...
| Example of sending a poll                                      | [sendPoll.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/sendPoll.php)                               |
| Example of sending interactive buttons                         | [sendInteractiveButtons.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/sendInteractiveButtons.php)   |
| Example of updating group settings                             | [updateGroupSettings.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/updateGroupSettings.php)         |
| Example of getting chats list                                  | [getChats.php](https://github.com/green-api/whatsapp-api-client-php/blob/master/examples/getChats.php)                               |
...
| `account.updateApiToken`               | The method is designed to update the instance API token                                                                  | [UpdateApiToken](https://green-api.com/en/docs/api/account/UpdateApiToken/)                                  |
...
| `groups.updateGroupSettings`           | The method changes group chat settings                                                                                   | [UpdateGroupSettings](https://green-api.com/en/docs/api/groups/UpdateGroupSettings/)                         |
...
| `sending.sendPoll`                     | The method is designed to send a poll message to a personal or group chat                                                | [SendPoll](https://green-api.com/en/docs/api/sending/SendPoll/)                                              |
| `sending.sendInteractiveButtons`       | The method is designed to send a message with interactive buttons to a personal or group chat                            | [SendInteractiveButtons](https://green-api.com/en/docs/api/sending/SendInteractiveButtons/)                  |
| `sending.sendInteractiveButtonsReply`  | The method is designed to send a reply message with interactive buttons to a personal or group chat                      | [SendInteractiveButtonsReply](https://green-api.com/en/docs/api/sending/SendInteractiveButtonsReply/)        |
...
| `serviceMethods.getChats`              | The method returns the list of chats of the current account                                                              | [GetChats](https://green-api.com/en/docs/api/service/GetChats/)                                              |
